package de.atomspace.timeline.tapestry.services;
	...
	public RequestExceptionHandler decorateRequestExceptionHandler(final Logger logger, final ResponseRenderer renderer, final ComponentSource componentSource,
		...
		return new RequestExceptionHandler() {
			public void handleRequestException(Throwable exception) throws IOException {
				...
				ExceptionReporter index = (ExceptionReporter) componentSource.getPage("status/Status500");

				index.reportException(exception);

				renderer.renderPageMarkupResponse("status/Status500");
			}
		};
	}
}
